		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#esvictornorthwindorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esvictornorthwindorders-display": {
								"semanticObject": "esvictornorthwindorders",
								"action": "display",
								"description": "Northwind Orders",
								"title": "Northwind Orders",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=es.victor.northwindorders",
									"url": sap.ui.require.toUrl("es/victor/northwindorders")
								}
							}
						}
					}
